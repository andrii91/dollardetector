...
gulp.task('sass', function() {
    return sass('src/sass/main.scss', { sourcemap: false, style: 'compact' })
...
gulp.task('js_v', function() {
    gulp.src([
            ...
            'src/js/vendor/inputmask.extensions.min.js',
            'src/js/vendor/inputmask.numeric.extensions.min.js',
        ])
